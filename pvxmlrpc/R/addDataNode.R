addDataNode <- function(pathway, name, type, host="localhost", port=9000, ref="", comment="", commentSource="", dataId="", dataSource="", path=NA) {
  ...
  xml.rpc(hostUrl, "PathVisio.addDataNode", pwyPath, name, type, ref, comment, commentSource, dataId, dataSource)
}
