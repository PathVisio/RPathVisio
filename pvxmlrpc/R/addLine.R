addLine <- function(pathway, name, startNode, endNode, startAnnotation="", endAnnotation="Arrow", host="localhost", port=9000) {
  ...
  xml.rpc(hostUrl, "PathwayHandler.addLine", pathway, name, startNode, endNode, startAnnotation, endAnnotation)
}
